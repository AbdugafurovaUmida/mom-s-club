...
const ProductsCard = ({item}) => {
  return (
    <div className='rounded-[30px] border-[3px] border-solid border-[#F1DBDA] md:pt-[56px] py-[50px] md:pb-[58px] flex justify-start items-center flex-col gap-10 bg-white'>
      ...
      <UnBorderedButton customLink={item.elLink} blank="_blank">Подробнее</UnBorderedButton>
    </div>
  )
}
