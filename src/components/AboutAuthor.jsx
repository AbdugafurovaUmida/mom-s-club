      ...
      <div className='container'>
        ...
        <div className='relative flex flex-wrap justify-between '>
          ...
          <div className='max-w-full xl:max-w-[49%] gap-4 w-full flex justify-around xl:justify-start '>
            <Image className="relative z-10 xl:bottom-[50px] xl:self-end shadow-picShadow  max-w-[340px] max-h-[340px]  w-full h-auto " src={certificate} alt='certificate' width={340} height={320} />
            <Image className="relative z-0 xl:top-[50px] xl:left-[-100px] hidden md:inline-block shadow-picShadow max-w-[340px] w-full max-h-[320px] h-auto" src={author} alt='author' width={340} height={320} />
          </div>
        </div>
      </div>
    </section>
