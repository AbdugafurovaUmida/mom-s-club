...
const Hero = () => {
  ...
  const renderBackdrop = (props) => <div className="fixed top-0 bottom-0 left-0 right-0 bg-black z-[1040px] hidden w-full h-full" {...props} />;
        ...
        <div className='container'>
          <div className='flex flex-col items-center md:flex-row'>
            <div className='md:pt-[118px] pt-[80px] md:text-left text-center'>
              <h1>
                {/* <span className='block mb-4 text-lg font-regular'>Mom&#x2019;s</span> */}
              ...
              <div className='flex flex-col items-center gap-5 mt-11 md:flex-row md:items-start'>
                <button className='max-w-[250px] inline-block' onClick={toggleModal}><UnBorderedButton>Записаться</UnBorderedButton></button>
